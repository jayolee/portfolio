...
export const projectList = {
    ...
    "logpos": {
        ...
        "Ideation": <div>
            <p> The prompt of Bose Challenge was <i><b>“How might we use sound-based augmented reality to improve our lives?”</b></i> Among the idea we had, we decided to focus on improving cooperation situations which require team members’ communications about their locations and status. More specifically, we narrowed down our target as firefighters, about their rescue operations in extreme situations.</p> <p>Our assumption here is that under the urgent circumstances of limited vision and hearing, it is difficult to communicate accurate location information via speaking. Therefore, we designed a way to communicate each other automatically generated location data based on their GPS with minimum hand control. </p><img src={logpos1} /><div className='imgdes'>Ideation Meeting</div> </div>,
        "User Research": <div>
        ...
        "Challenges": <div><div className='title logpos' >Technical Challenge:</div>How can we get the accurate indoor location data?<div className='solution'><li>To get accurate location data, we designed our device to use the bluetooth devices for better location accuracy.</li></div><div className='title logpos'>Social Constraints:</div>According to the interview, there are two social constraints:<br />Firefighters sometimes rely on their ears to determine the temprature. Therefore, there should not be a thing cover their ears.<br /> Firefighters resist change, especially if it is going to be hard to put on. <div className='solution'> <li>We designed an audio AR device satisfying these challenges. </li></div><img src={logpos3} /><div className='imgdes'>Device Desiged by <a href='http://www.hyunwoopaik.com' target='_blank'>Hyun Woo Paik</a></div></div>,

        "Final Design": <div><p>To create a video explining our idea, we made a scenario conveying how our design can be applied to the target situations.</p> <img className="half" src={logposstory1} /> <img className="half" src={logposstory2} /><div className="imgdes">Video Storyboard by Ja Young Lee</div><p>The device can be controlled with verbal and head motions.</p><div className="control"><img id="connected" src={logposrun1} /></div><li className="animdes">Team members connect the devices before getting into the operation.</li><div className="control"><img className="anim continuImg" src={logposrun2} /><img className="continuImg" src={logposrun3} /></div><div className="imgdes">Hover on the image</div><li className="animdes">Users will continuously get the messages from others as walkie-talkie</li><div className="control"><img className="anim" src={logposrun4} /><img src={logposrun5} /></div><div className="imgdes">Hover on the image</div><li className="animdes">With a verbal control of <b><i>"Locate All,"</i></b> a user will continuously get the location information of everyone based on his or her head direction. </li><div className="control"><img className="anim" src={logposrun6} /> <img src={logposrun7} /></div><div className="imgdes">Hover on the image</div><li className="animdes">With a verbal control of <b><i>"Locate [Name],"</i></b> a user will get a specific person's location based on his or her head direction.</li> <div className="control"><img className="anim" src={logposrun8} /><img src={logposrun9} /></div><div className="imgdes">Hover on the image</div><li className="animdes">When a user wants to communicate with other people, he or she will push the button on the side, and will speak. This message will go to everyone as walkie-talkie.</li><div className="control"><img id="deactivate" src={logposrun10} /> </div><li className="animdes">When a user wants to stop getting the location information, he or she can speak <b><i>"Deactivate"</i></b> to stop the function.</li></div>
    },
    "dote": {
        ...
        "Ideation": <div>
            ...
            Using AR technology, we focused on messaging emotions related to locations.
                With DoteNote, users can leave 3D messages at specific locations.</p><img className="half" src={dote1} />
            <img className="half" src={dote2} />
        ...
        "Final Design": <div>
            <div className="screens">
                <img className="screens" src={dote6} />
                <img className="screens" src={dote7} />
                <img className="screens" src={dote8} />
                <img className="screens" src={dote9} />
            </div>
            <div className="screens">
                <img className="screens" src={dote10} />
                <img className="screens" src={dote11} />
                <img className="screens" src={dote12} />
                <img className="screens" src={dote13} />
                <img className="screens" src={dote14} />
            </div></div>,
    ...
    "reporter": {
        ...
        "topimg": <img id="reporter" className="topimg" src={reporter0} />,
        "exlpla": {
  ...
  of the application.
        ...
        "Design Changes": <div className="center">
            <div className="evensc before"> <img src={even1} />
                <div className="ori">Original</div>
            </div>
            <div className="evensc after"> <img src={even2} /> <img src={even3} />
        ...
        "Prototype": <div>
            <img className="half" src={even4} />
        </div>,
        "Process": <div>
            <div className="center">
                <div className="evenwrapper inpfld"> <img src={even1} />
                    <div className="spot blu" />
                </div>
                <div className="evenwrapper inpfld"> <img src={even2} />
            ...
            <div className="center">
                <div className="evenwrapper maparea"> <img src={even1} />
                    <div className="spot blu" />
                </div>
                <div className="evenwrapper maparea"> <img src={even2} />
                    <div className="spot red" />
                </div>
            </div>
            <br />
            ...
            <div className="center">
                <div className="evenwrapper bicons"> <img src={even1} />
                    <div className="spot blu" />
                </div>
                <div className="evenwrapper bicons"> <img src={even2} />
                    <div className="spot red" />
                </div>
            </div>
            <br />
        ...
        "Emojis":
            <div>
                ...
                <div className="animation_wrap">
                    ...
                    <div className="aniwrap">
                        <img className="thumb" src={momo4_1} />
                        <img className="ani" src={momo4_2} />
                    </div>
                    <div className="aniwrap">
                        <img className="thumb" src={momo5_1} />
                        <img className="ani" src={momo5_2} />
                    </div>
                    {anigenerator()}
                </div>
            </div>
    ...
    "naoshima": {
        ...
        "topimg": <img id='reporter' className="topimg" src={naoshima} />,
        "exlpla": {
            "Time": "Sep 2018",
            "Team": "Ja Young Lee",
