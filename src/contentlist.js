...
module.exports ={
    contents:{
      ...
      />,
        ...
        "Challenges":<div><div className='title logpos' >Technical Challenge:</div>How can we get the accurate indoor location data?<div class='solution'><li>To get accurate location data, we designed our device to use the bluetooth devices for better location accuracy.</li></div><div class='title logpos'>Social Constraints:</div>According to the interview, there are two social constraints:<br />Firefighters sometimes rely on their ears to determine the temprature. Therefore, there should not be a thing cover their ears.<br /> Firefighters resist change, especially if it is going to be hard to put on. <div class='solution'> <li>We designed an audio AR device satisfying these challenges. </li></div><img src={logpos3} /><div class='imgdes'>Device Desiged by <a href='http://www.hyunwoopaik.com' target='_blank'>Hyun Woo Paik</a></div></div>,
      ...
      />,
        ...
        "Challenges":<div>
                        ...
                        <li className="aninmdes">If a user is on the same side of the street, they can see the message by looking around.</li>

                        <img className="solu_dote" src={dote5} />
                        <li className="animdes">If a user is around the corner, because the notification comes up when they enter the range of one block, they can know which direction the message is located. If they are from the side where the message is located, they get the notification before they enter the street.</li></div>,
      ...
      "reporter":{
        ...
        "topimg":<img id={this.props.idnum} className="topimg" src={reporter0}/>,
        "exlpla":{
