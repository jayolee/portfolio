                ...
                <div className="FAdetail Facv" style={{ top: "0" }}>
                    ...
                    <div className="FAcv_detail">
                        ...
                        <div className="biocontent">
                            <div className="bioyear">2020</div>
                            <div className="bioname"> <span class="title">"The 2020 MRAC Annual Juried Show"</span> at Manayunk-Roxborough Art Center, Philadelphia, PA
        </div>
                        </div>
                        <div className="biocontent">
